...
public final class ConfigRenderOptions {
    ...
    private ConfigRenderOptions(boolean originComments, boolean comments, boolean formatted,
                                boolean json, ConfigSorter configSorter) {
    ...
    public static ConfigRenderOptions defaults() {
        return new ConfigRenderOptions(true, true, true, true, ConfigSortingOptions.defaultSorter());
    }
    ...
    public static ConfigRenderOptions concise() {
        return new ConfigRenderOptions(false, false, false, true, ConfigSortingOptions.defaultSorter());
    }
    ...
    public ConfigRenderOptions setComments(boolean value) {
        if (value == comments)
            ...
            return new ConfigRenderOptions(originComments, value, formatted, json, configSorter);
    }
    ...
    public ConfigRenderOptions setOriginComments(boolean value) {
        if (value == originComments)
            ...
            return new ConfigRenderOptions(value, comments, formatted, json, configSorter);
    }
    ...
    public ConfigRenderOptions setFormatted(boolean value) {
        if (value == formatted)
            ...
            return new ConfigRenderOptions(originComments, comments, value, json, configSorter);
    }
    ...
    public ConfigRenderOptions setJson(boolean value) {
        if (value == json)
            ...
            return new ConfigRenderOptions(originComments, comments, formatted, value, configSorter);
    }
    ...
    public ConfigRenderOptions setConfigSorter(ConfigSorter configSorter) {
        if (this.configSorter == configSorter) {
            return this;
        }
        return new ConfigRenderOptions(originComments, comments, formatted, json, configSorter);
    }
